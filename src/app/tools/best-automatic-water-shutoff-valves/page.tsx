  ...
  return (
    <>
      ...
      <Section padding="sm" size="md">
        ...
        <RecommendedProductsSection heading="Our picks" intro={<p>For a whole-house solution, a flow-sensing smart valve (Moen Flo, Phyn) is the most complete option. For a lower-cost targeted approach, a sensor-triggered shutoff covers the water heater and washer without cutting into the main.</p>} products={products} evidence={{ basis: "editorial-research", lastChecked: updatedAt, sources: ["Manufacturer specifications and instruction sheets", "Manufacturer flow-rate and valve-actuation specifications", "Verified owner reports on retailer and manufacturer sites", "The author's own repair experience"] }} />
        <BuyingGuideSections
