  ...
  return (
    <>
      ...
      <Section padding="sm" size="md">
        ...
        <RecommendedProductsSection heading="Our picks" intro={<p>Start with hose bib covers and foam sleeves on every exposed run. Add self-regulating heat cable only on lines in unheated spaces or lines that have frozen before.</p>} products={products} evidence={{ basis: "editorial-research", lastChecked: updatedAt, sources: ["Manufacturer specifications and instruction sheets", "UL 1588 (heat cable) and manufacturer R-value data", "Verified owner reports on retailer and manufacturer sites", "The author's own repair experience"] }} />
        <BuyingGuideSections
