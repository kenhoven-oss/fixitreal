  ...
  return (
    <>
      ...
      <Section padding="sm" size="md">
        ...
        <RecommendedProductsSection heading="Our picks" intro={<p>Three products: the gauge to take the reading, the memory-hand version that catches overnight spikes, and the PRV that fixes high pressure permanently.</p>} products={products} evidence={{ basis: "editorial-research", lastChecked: updatedAt, sources: ["Manufacturer specifications and instruction sheets", "IPC/UPC residential pressure limits (80 psi)", "Verified owner reports on retailer and manufacturer sites", "The author's own repair experience"] }} />
        <BuyingGuideSections
