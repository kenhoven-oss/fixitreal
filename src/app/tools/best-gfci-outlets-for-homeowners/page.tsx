  ...
  return (
    <>
      ...
      <Section padding="sm" size="md">
        ...
        <RecommendedProductsSection heading="Our picks" intro={<p>Match amperage to the circuit breaker (15A or 20A) and location to the outlet type. Self-testing models are worth the extra $5 in every case.</p>} products={products} evidence={{ basis: "editorial-research", lastChecked: updatedAt, sources: ["Manufacturer specifications and instruction sheets", "UL 943 listing and NEC 210.8 requirements", "Verified owner reports on retailer and manufacturer sites", "The author's own repair experience"] }} />
        <BuyingGuideSections
