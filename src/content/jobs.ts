...
export const jobs: readonly Job[] = [
  ...
  /* ------------------------------------------------------------------ */
  {
    ...
    rationale:
      "Water heater replacement is the job where the homeowner overconfidence trap catches the most people. The plumbing connections are not hard. But the peripheral requirements — a properly sized expansion tank matched to your municipal pressure, a drip pan with an active drain or alarm, T&P valve discharge routed to a safe location, seismic strapping (West Coast), a proper sediment trap on gas lines, and code-compliant venting for gas units — turn a simple swap into a system. Local inspectors fail DIY water-heater installs constantly, usually not because the homeowner couldn't connect the pipes but because they skipped one or two of the code items. The permit requirement alone makes this a 'hire it' job in most jurisdictions: skipping the permit can complicate an insurance claim for water damage if the tank fails, and shows up as an unpermitted install at resale.",
    ifYouDiy:
