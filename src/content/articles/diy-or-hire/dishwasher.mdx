...
howTo:
  ...
  steps:
    - name: "Shut off water and power"
      text: "Close the hot-water supply valve under the kitchen sink, then trip the dishwasher's circuit breaker. Verify both are off before disconnecting anything."
    - name: "Disconnect the old unit"
      text: "Loosen the supply line at the bottom of the dishwasher. Disconnect the drain hose from under the sink or air gap. Open the kick plate at the front and disconnect the power wires (hardwired) or unplug (plug-in)."
    - name: "Slide the old dishwasher out"
      text: "Unscrew the mounting brackets at the top of the unit (attached to the underside of the counter). Lower the leveling legs slightly so the unit clears the floor, then pull it forward."
    - name: "Prep the new unit on the floor"
      text: "Attach the new supply line elbow fitting. Connect the drain hose if not pre-attached. Connect the wiring kit at the front access panel."
    - name: "Slide the new dishwasher into position"
      text: "Walk the unit into the cabinet opening, leveling as you go. Don't kink the drain hose or supply line as it goes in."
    - name: "Connect water, drain, and power"
      text: "Connect the supply line to the hot-water valve under the sink. Route the drain hose with a high loop (touching the underside of the countertop) before going to the disposal or air gap. Connect power per local code."
    - name: "Anchor the unit and level it"
      text: "Screw the mounting brackets at the top of the unit into the underside of the counter. Use the leveling legs to bring the front edge flush with the cabinet face."
    - name: "Restore water and power, run a test cycle"
      text: "Open the water supply valve. Turn on the breaker. Run a short cycle and watch underneath for leaks at every connection. Fix any drip before normal use."
