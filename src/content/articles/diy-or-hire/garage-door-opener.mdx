...
<PrintReadyFormsCTA
  contextLabel="Before signing the quote"
  title="Use a written scope, not a handshake."
  description="Garage door opener work should state the opener model, rail length, safety-sensor setup, removal of old equipment, warranty terms, and what's explicitly excluded. A scope-of-work form prevents the 'that wasn't in the price' conversation later."
  buttonText="Use a scope and estimate form"
  href="https://www.printreadyforms.com/product/contractor-estimate-quote-pack"
  utmCampaign="garage_door_opener_scope"
/>
