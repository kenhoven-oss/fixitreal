---
title: "Drywall repair after a leak: check this first"
slug: "drywall-damage-after-a-leak"
pillar: "advice"
description: "Drywall water damage: what to check behind the wall before you patch, when to replace vs. repair, and the order that keeps you from sealing in mold."
author: "ken-hoven"
ymyl: true
...
relatedCost: "ceiling-water-damage-repair-cost"
faq:
...
<QuickAnswer tone="triage" label="Stop and bring in a pro if">
- **Visible mold growth** (black, green, or fuzzy patches) or a **strong musty smell** when the wall opens — mold remediation is not a DIY job.
- **The leak was from sewage, a sewer backup, or "black water"** — licensed remediation is required regardless of damage size.
- **A ceiling panel is sagging or soft** — that's a falling hazard. Cut it out or call a pro; don't paint or patch over it.
- **Moisture readings in the framing still exceed 17% after several days of drying** — closing the wall now will trap water against the studs.

If none of those apply, patching water-damaged drywall is straightforward. Read on — but dry it fully before you close it up.
</QuickAnswer>
