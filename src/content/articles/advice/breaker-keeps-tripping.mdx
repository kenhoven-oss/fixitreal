---
title: "Breaker keeps tripping: causes, safe checks, when to call"
...
<QuickAnswer tone="triage" label="Stop and call an electrician now if">
- The breaker trips **instantly on reset**, especially with nothing plugged in.
- Anything near the panel or an outlet **smells burnt, warm, or smoky**.
- A breaker is **hot to the touch**, or there's **crackling or buzzing** at an outlet.
- You see **discolored outlets or switch plates**, or **lights flicker across multiple rooms**.

Otherwise, the breaker is almost certainly doing its job — the cause is usually an overload, a failing appliance, or a ground fault. Read on.
</QuickAnswer>
...
<ProductPicks id="breaker-diagnosis-tools" />
...
GFCI breakers or outlets, required in kitchens, bathrooms, garages, outdoors, and near sinks, detect current leaking to ground. A GFCI that trips every time it rains outside usually means water is getting into an outdoor outlet or fixture, not that the GFCI is "bad." If you have a GFCI outlet that trips on its own with nothing plugged in, [our GFCI-specific troubleshooting guide](/advice/gfci-outlet-keeps-tripping) walks through that pattern — and our [replace-an-outlet-or-GFCI verdict](/tools/diy-or-hire/replace-outlet-gfci) covers when a worn GFCI is a safe homeowner swap and when it's not.
...
For context on typical hourly rates, trip charges, and minimum visit fees, see our [electrician hourly cost guide](/costs/electrician-hourly). Quick ranges for the common breaker-related jobs:
...
- Panel replacement: usually $1,800 to $4,500+, more in older homes with aluminum branch wiring or legacy panels with known safety histories. Our [panel replacement verdict](/tools/diy-or-hire/replace-panel) explains why this is one of the few jobs we tell homeowners never to DIY.
