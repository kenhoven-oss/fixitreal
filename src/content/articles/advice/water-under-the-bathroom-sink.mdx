...
related:
  ...
  - path: "/what-is-this/water-under-bathroom-sink"
    label: "Water under the bathroom sink — quick ID"
---
...
The cheapest leak is the one you catch in the first hour. A small [Wi-Fi water leak alarm set](https://www.amazon.com/s?k=wifi+water+leak+detector+multi+pack&tag=fixitreal-20) tucked into the back of the vanity will ping your phone the moment the cabinet floor gets wet — long before the particleboard swells. Pair it with calendar-reminded supply-line checks every couple of years and most under-sink damage never gets started.
