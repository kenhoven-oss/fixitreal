...
related:
  ...
  - path: "/advice/roto-rooter-vs-local-plumber"
    label: "Roto-Rooter vs local plumber"
---
...
<PrintReadyFormsCTA
  contextLabel="Getting comparable quotes"
  title="Hand all three contractors the same written scope."
  description="Quotes only compare when they price the same job. This pack is written for contractors, but two of its four forms work from the hiring side: a scope-of-work sheet you fill in once and give to every bidder, and a bid comparison matrix that lines the three quotes up item by item."
  buttonText="See the scope and bid-comparison forms"
  href="https://www.printreadyforms.com/product/contractor-estimate-quote-pack"
  utmCampaign="three_quotes_scope"
/>
