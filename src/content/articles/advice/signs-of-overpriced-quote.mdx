...
<PrintReadyFormsCTA
  contextLabel="Countering vague language"
  title="If they won't itemize, itemize it for them."
  description="A written scope of work you supply forces the line-item breakdown a vague proposal is avoiding. This pack is built for contractors, but its scope-of-work template and change-order form are the same two documents that protect you on the hiring side."
  buttonText="See the scope-of-work template"
  href="https://www.printreadyforms.com/product/contractor-estimate-quote-pack"
  utmCampaign="overpriced_quote_scope"
/>
